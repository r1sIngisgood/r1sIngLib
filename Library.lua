...
getgenv().hubConfiguration = {["Font"] = Enum.Font.Jura}
...
function lib:NewWindow(guiName, discordLink)
    ...
    GuiName.ZIndex = 2
    GuiName.Font = getgenv().hubConfiguration["Font"] or Enum.Font.Jura
    ...
    HomeTabDividerText.Font = getgenv().hubConfiguration["Font"] or Enum.Font.Jura
    ...
    HomeDescription.Font = getgenv().hubConfiguration["Font"] or Enum.Font.Jura
    ...
    HomeTabButton.Font = getgenv().hubConfiguration["Font"] or Enum.Font.Jura
    ...
    function HomeLib:AddText(Text)
        ...
        newHomeText.Font = getgenv().hubConfiguration["Font"] or Enum.Font.Jura
    ...
    function Windowlib:NewTab(TabName)
        ...
        itTabButton.Font = getgenv().hubConfiguration["Font"] or Enum.Font.Jura
        ...
        itTabName.ZIndex = 2
        itTabName.Font = getgenv().hubConfiguration["Font"] or Enum.Font.Jura
        ...
        function Tablib:NewButton(Text, Callback)
            ...
            newButton.Font = getgenv().hubConfiguration["Font"] or Enum.Font.Jura
            newButton.Text = ""
        ...
        function Tablib:NewDivider(Text)
            ...
            newDividerText.Font = getgenv().hubConfiguration["Font"] or Enum.Font.Jura
        ...
        function Tablib:NewToggle(Text, Callback, defaultState)
            ...
            newToggleText.Font = getgenv().hubConfiguration["Font"] or Enum.Font.Jura
